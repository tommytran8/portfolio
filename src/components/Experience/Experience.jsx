    ...
    <div className="experience">
      <ul>
        <li>
          ...
          <p>
            <b>Duration:</b> February 2021 - Present
          </p>
          <p>
          ...
          <p>
            <b>Project:</b> ClickUp Web Platform
          </p>

          <p>
            <b>Description:</b> The ClickUp platform strives to be the
          ...
          <p>
            <b>Responsibilities:</b> Developed and maintained front-end projects
        ...
        <li>
          ...
          <p>
            <b>Duration:</b> November 2019 - January 2021
          </p>
          <p>
            <b>Location:</b> San Diego, CA
          </p>
          ...
          <p>
            <b>Project:</b> Veyo Web Portal
          </p>

          <p>
            <b>Description:</b> Veyo technology was built to help the health
          ...
          <p>
            <b>Responsibilities:</b> Developed projects with cutting-edge web
        ...
        <li>
          <p>
            <b>Client:</b> Verimatrix
          </p>
          <p>
            <b>Duration:</b> July 2018 - September 2019
          </p>
          <p>
            <b>Location:</b> San Diego, CA
          </p>
          ...
          <p>
            <b>Project:</b> Secure Delivery Platform
          </p>

          <p>
            <b>Description:</b> The Verimatrix Secure Delivery Platform is a
          ...
          <p>
            <b>Responsibilities:</b> Developed clickable prototypes and migrated
